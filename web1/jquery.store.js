...
/* Format a number by decimal places @param num Number the number to be formatted @param places Number the decimal places @returns n Number the formatted number*/
_formatNumber: function( num, places ) {
var n = num.toFixed( places );
return n;
},
/* Extract the numeric portion from a string @param element Object the jQuery element that contains the relevant string @returns price String the numeric string*/
...
/* Converts a numeric string into a number @param numStr String the numeric string to be converted@returns num Number the number*/
...
/* Converts a number to a string @param n Number the number to be converted @returns str String the string returned*/
_convertNumber: function( n ) {
var str = n.toString();
return str;
},
/* Converts a JSON string to a JavaScript object @param str String the JSON string@returns obj Object the JavaScript object*/
_toJSONObject: function( str ) {
var obj = JSON.parse( str );
return obj;
},
/* Converts a JavaScript object to a JSON string @param obj Object the JavaScript object @returns str String the JSON string*/
_toJSONString: function( obj ) {
var str = JSON.stringify( obj );
return str;
},
/* Add an object to the cart as a JSON string @param values Object the object to be added to the cart @returns void*/
...
/* Custom shipping rates calculation based on the total quantity of items in the cart @param qty Number the total quantity of items @returns shipping Number the shipping rates */
...
/* Validates the checkout form @param form Object the jQuery element of the checkout form @returns valid Boolean true for success, false for failure */
...
/* Save the data entered by the user in the ckeckout form @param form Object the jQuery element of the checkout form @returns void */
